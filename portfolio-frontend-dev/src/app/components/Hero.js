	...
	return (
		<>
			<section id="home" className="dark h-[100vh]">
				<div className=" h-screen scroll-smooth bg-cover bg-end bg-repeat-space flex flex-col items-center justify-center p-10 bg-gradient-to-b from-white to-purple-300">
					...
					<p className="font-[Arial] text-[1.7rem] p-5 text-black  text-center text-4xl mt-4 cursor-default">
						<TypeAnimation
							sequence={[
								"Web developer",
								1000,
